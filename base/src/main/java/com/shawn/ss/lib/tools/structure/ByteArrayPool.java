...
public class ByteArrayPool {
    ...
    public static final int MAX_LEN_IN_BYTE_POOL_SIZE = 102400;
    /**
    ...
    public static ByteArrayPool getInstance(Integer sizeLimit) {
        if (instance == null) {
            synchronized (ByteArrayPool.class) {
                int size = sizeLimit == null ? MAX_LEN_IN_BYTE_POOL_SIZE : sizeLimit;
                instance = new ByteArrayPool(size);
            }
        }
        return instance;
    }
    ...
    public static void clear() {
        synchronized (ByteArrayPool.class) {
            instance.mBuffersByLastUse.clear();
            instance.mBuffersBySize.clear();
            instance = null;
        }
    }
