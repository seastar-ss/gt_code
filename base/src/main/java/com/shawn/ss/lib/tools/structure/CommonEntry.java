...
public class CommonEntry<K, V>  implements  java.io.Serializable,Map.Entry<K,V> {
	 ...
	 */
	public CommonEntry(K key, V value) {
		this.key = key;
		this.value = value;
	}
	 ...
	 *            the entry to copy
	 */
	public CommonEntry(Entry<? extends K, ? extends V> entry) {
