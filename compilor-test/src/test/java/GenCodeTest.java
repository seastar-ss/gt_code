...
//        JavaFileObject file = new JavaSourceFromString("HelloWorld", writer.toString());
        ...
        List<String> options= CollectionHelper.<String>listBuilder()
                ...
                .add(cp)
//                .add("-processorpath")
//                .add("C:\\projects\\LatestWorkSpace\\common-mid-plugin\\compilor\\compilor-base-all-1.0.jar")
//                .add("-processor")
//                .add("com.shawn.ss.gen.GenProcessor")
                .add("-d")
                .add(output.getAbsolutePath())
                .add("-Aconf.file=C:\\projects\\LatestWorkSpace\\common-mid-plugin\\project")
////                .add("")
                .add("-Asrc.base.fold=C:\\projects\\LatestWorkSpace\\common-mid-plugin\\common-script\\dmo-gen\\src\\main\\java")
////                .add("")
...
//                Collections.singletonList("C:\\workspace\\common-mid-plugin\\common-script\\war\\src\\main\\java"),
                Collections.singletonList("C:\\projects\\LatestWorkSpace\\common-mid-plugin\\common-script\\dmo-gen\\src\\main\\java"),
                allSrcFile
        );
...
// cessor");
        ...
        if(size>0) {
            task.setProcessors(Collections.singleton(new GenProcessor()));
