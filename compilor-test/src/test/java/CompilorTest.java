...
public class CompilorTest {
    ...
    //
    String baseFolder = "C:\\projects\\LatestWorkSpace\\common-mid-plugin";
...
//        File baseLib=new File("C:\\workspace\\common-mid-plugin\\common-script\\war\\target\\lib");
        File baseLib = new File(baseFolder + "\\common-script\\war\\target\\lib");
...
//                Collections.singletonList("C:\\workspace\\common-mid-plugin\\common-script\\war\\src\\main\\java"),
                Collections.singletonList(baseFolder + "\\common-script\\war\\src\\main\\java"),
                allSrcFile
        );
...
//                .add(lombokProcessor)
                .add(
                        new GenProcessor()
//                                .putOptions(Constants.KEY_SERVER_ENDPOINT,"http://1
// 72.16.112.54:12098/script/script/add")
//                                .putOptions(Constants.KEY_SERVER_ENDPOINT, endPoint)
//                                .putOptions(Constants.KEY_BASE_PACKAGE, "com.sunlands.script_common_war")
//                                .putOptions(Constants.KEY_APP_ID, "script-manager")
//                                .putOptions(Constants.KEY_ASPECT_TEMPLATE,"C:\\workspace\\common-mid-plugin\\compilor-base\\src\\main\\resouces\\AspectConfig.stg")
//                                .putOptions(Constants.KEY_GEN_SRC_POSITION,"C:\\workspace\\common-mid-plugin\\common-script\\war\\src\\main\\java\\com\\sunlands\\script_common_war\\base_service\\config")
//                                .putOptions(Constants.KEY_ASPECT_TEMPLATE, baseFolder + "\\compilor-base\\src\\main\\resouces\\AspectConfigFinal.stg")
//                                .putOptions(Constants.KEY_GEN_SRC_POSITION, baseFolder + "\\common-script\\war\\src\\main\\java")
//                                .addFeature(new Feature[]{Feature.scan})

//                                .putOptions(Constants.KEY_ASPECT_TEMPLATE,"D:\\project\\newProject\\new_code_gen\\code-analyzer\\common-mid-plugin\\compilor-base\\src\\main\\resouces\\AspectConfigV7.stg")
//                                .putOptions(Constants.KEY_GEN_SRC_POSITION,"D:\\project\\newProject\\new_code_gen\\code-analyzer\\common-mid-plugin\\maven-plugin\\src\\test\\java\\gen")
                )
