...
String colName = null;
        ...
        {if ("" != null) return new Column(table, colName);}
    throw new Error("Missing return statement in function");
  }
...
union.setPlainSelects(selects);
  ...
  final public List WithList() throws ParseException {ArrayList withItemsList = new ArrayList();
        WithItem with = null;
...
{if ("" != null) return with;}
  ...
  final public List SelectItemsList() throws ParseException {ArrayList selectItemsList = new ArrayList();
...
{if ("" != null) return retval;}
  ...
  final public List GroupByColumnReferences() throws ParseException {Expression columnReference = null;
...
{if ("" != null) return having;}
  ...
  final public List OrderByElements() throws ParseException {List orderByList = new ArrayList();
...
retval = new JdbcParameter();
    ...
    case S_NAMED_PARAM:{
      token = jj_consume_token(S_NAMED_PARAM);
retval=new JdbcNamedParameter(token.image.substring(1));
      break;
      }
    default:
      jj_la1[120] = jj_gen;
...
{if ("" != null) return retval;}
  ...
  final public String AList() throws ParseException {StringBuffer retval = new StringBuffer("(");
        Token tk = null;
    jj_consume_token(80);
    label_33:
    while (true) {
...
retval.append(")");
  ...
  final public List ColumnsNamesList() throws ParseException {List retval = new ArrayList();
        Token tk = null;
    jj_consume_token(80);
    tk = jj_consume_token(S_IDENTIFIER);
retval.add(tk.image);
...
{if ("" != null) return truncate;}
 ...
 {
    if (jj_scan_token(S_NAMED_PARAM)) return true;
    return false;
  }
  ...
  private boolean jj_3R_75()
 {
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x10000,0x2000,0x8000,0x0,0x0,0x8000,0x8000,0x8000,0x10000,0x10000,0x0,0x8000,0x8000,0x20000,0x10000,0x0,0x0,0x40000,0x40000,0x880,0x880,0x880,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x1,0x1,0x0,0x0,0x1,0x1,0x0,0x1,0x1,0x10000,0x8000,0x10000,0x8000,0x880,0x80000,0x80111c8c,0x0,0x8000,0x10000,0x10880,0x880,0x8000,0x0,0x0,0x0,0x0,0x8000,0x8000,0x0,0x0,0x8000,0x8000,0x0,0x0,0x100008,0x100008,0x100008,0x100008,0x100008,0x0,0x0,0x100008,0x10000,0x0,0x10000,0x0,0x10000,0x80111c8c,0x0,0x6000000,0xfe04000,0x80111c8c,0x0,0x80111c8c,0x0,0x0,0x0,0x0,0x0,0x8000,0x8000,0x80111c8c,0x0,0x10000,0x10000000,0x60000000,0x80000000,0x10000,0x80000,0x10000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x101000,0x80010400,0x0,0x0,0x0,0x0,0x80111c8c,0x0,0x880,0x40000,0x40000,0x1,0x1,0x80191c8c,0x80191c8d,0x0,0x1448c,0x1448c,0x8000,0x1448c,0x80,0x1448c,0x10000,0x408,0x408,0x8000,0x1448c,0x48c,0x48c,0x8000,0x8000,0x80,0x80,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe9,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe9,0x0,0x0,0x0,0xe9,0x0,0xe9,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe9,0x0,0x0,0x0,0x0,0x1,0x0,0x2,0x0,0x4,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x0,0x69,0x0,0x0,0x0,0x0,0xe9,0x80,0x0,0x0,0x0,0x0,0x0,0xe9,0xe9,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
