    ...
    implements DaoInterface<com.shangde.ent_portal.logical.dto.basepo.ModelTUserInfo, Integer> , InitializingBean
{
    ...
    protected List<ModelTUserInfo> getResults(DaoAssembler assembler, SQLSelect sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
    ...
    protected ModelTUserInfo getResult(DaoAssembler assembler, SQLSelect sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
            status = assembler.assembleSql(sqlBuilder, param, ModelTUserInfo.class);
        }
    ...
    protected void buildConditionCluase(SQLSelect sqlBuilder, ModelTUserInfo instance, Map<String, Object> param) {
        ...
        if (dReg_servicePage!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_REG_SERVICEPAGE, ColumnDataType.stringData);
        ...
        if (dReg_landingPage!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_REG_LANDINGPAGE, ColumnDataType.stringData);
            param.put(ModelTUserInfo.FI_REG_LANDINGPAGE, dReg_landingPage);
        }
        Byte dSync_bbs = instance.getSyncBbs();
        if (dSync_bbs!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_SYNC_BBS, ColumnDataType.byteData);
            param.put(ModelTUserInfo.FI_SYNC_BBS, dSync_bbs);
        }
        String dNickname_bbs = instance.getNicknameBbs();
        if (dNickname_bbs!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_NICKNAME_BBS, ColumnDataType.stringData);
        ...
        if (dExam_province!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_EXAM_PROVINCE, ColumnDataType.stringData);
        ...
        if (dHadiths_user_id!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_HADITHS_USER_ID, ColumnDataType.intData);
        ...
        if (dMaterial_province!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_MATERIAL_PROVINCE, ColumnDataType.intData);
        ...
        if (dFirst_project_ids!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_FIRST_PROJECT_IDS, ColumnDataType.stringData);
            param.put(ModelTUserInfo.FI_FIRST_PROJECT_IDS, dFirst_project_ids);
        }
        String dSignature = instance.getSignature();
        if (dSignature!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_SIGNATURE, ColumnDataType.stringData);
            param.put(ModelTUserInfo.FI_SIGNATURE, dSignature);
        }
        Long dIm_user_id = instance.getImUserId();
        if (dIm_user_id!= null) {
            sqlBuilder.itemWhere(ModelTUserInfo.FI_IM_USER_ID, ColumnDataType.longData);
    ...
    public List<ModelTUserInfo> get(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count) {
        ...
        sqlBuilder.table(ModelTUserInfo.DTO_TABLE_NAME);
        if (start == null) {
    ...
    public Integer updateByIds(ModelTUserInfo instance, Set<Integer> ids, DaoAssembler assembler) {
        ...
        sqlBuilder.itemWhere(LogicalOpType.in, ModelTUserInfo.FI_ID, "ids", ColumnDataType.intData);
        instance.setId(null);
        String dMobile = instance.getMobile();
        if (dMobile!= null) {
            sqlBuilder.itemCol(ModelTUserInfo.FI_MOBILE);
