    ...
    implements DaoInterface<com.shangde.ent_portal.logical.dto.basepo.ModelWikiStructureInfoKeyItem, Integer> , InitializingBean
{
    ...
    protected List<ModelWikiStructureInfoKeyItem> getResults(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
    ...
    protected ModelWikiStructureInfoKeyItem getResult(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
            status = assembler.assembleSql(sqlBuilder, param, ModelWikiStructureInfoKeyItem.class);
        }
    ...
    protected void buildConditionCluase(SQLSelect<SQLSelect> sqlBuilder, ModelWikiStructureInfoKeyItem instance, Map<String, Object> param) {
        Integer dItemId = instance.getItemId();
        if (dItemId!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMID, ColumnDataType.intData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMID, dItemId);
        }
        String dItemName = instance.getItemName();
        if (dItemName!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMNAME, ColumnDataType.stringData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMNAME, dItemName);
        }
        EnumItemType dItemType = instance.getItemType();
        if (dItemType!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMTYPE, ColumnDataType.byteData);
        ...
        if (dItemValueType!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMVALUETYPE, ColumnDataType.byteData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMVALUETYPE, dItemValueType.val);
        }
        String dItemLabel = instance.getItemLabel();
        if (dItemLabel!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMLABEL, ColumnDataType.stringData);
        ...
        if (dItemReadOnly!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMREADONLY, ColumnDataType.byteData);
        ...
        if (dItemObtainMethod!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMOBTAINMETHOD, ColumnDataType.stringData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMOBTAINMETHOD, dItemObtainMethod);
        }
        Byte dItemDeleteFlag = instance.getItemDeleteFlag();
        if (dItemDeleteFlag!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG, ColumnDataType.byteData);
        ...
        if (dItemBelongCollection!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION, ColumnDataType.intData);
        ...
        if (dItemDesp!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMDESP, ColumnDataType.stringData);
        ...
        if (dItemSequence!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE, ColumnDataType.byteData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE, dItemSequence);
        }
        Short dItemHasValue = instance.getItemHasValue();
        if (dItemHasValue!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, ColumnDataType.shortData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, dItemHasValue);
        }
        String dItemDefaultValue = instance.getItemDefaultValue();
        if (dItemDefaultValue!= null) {
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, ColumnDataType.stringData);
            param.put(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, dItemDefaultValue);
        }
    }
    ...
    protected void buildSelectFieldCluase(SQLSelect<SQLSelect> sqlBuilder, Set<String> selectFields) {
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMID)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMID);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMNAME)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMNAME);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMTYPE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMTYPE);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMVALUETYPE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMVALUETYPE);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMLABEL)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMLABEL);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMREADONLY)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMREADONLY);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMOBTAINMETHOD)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMOBTAINMETHOD);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDESP)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMDESP);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE);
        }
        if (selectFields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE);
        }
    }
    ...
    public List<ModelWikiStructureInfoKeyItem> get(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count) {
        ...
        SQLSelect<SQLSelect> sqlBuilder = SQL.buildSelectSql(ModelWikiStructureInfoKeyItem.DTO_TABLE_NAME);
        if (start == null) {
    ...
    public List<ModelWikiStructureInfoKeyItem> getById(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count, List<Integer> itemId) {
        ...
        buildSelectFieldCluase(sqlBuilder, selectFields);
        if (itemId!= null) {
            sqlBuilder.where(LogicalRelationshipType.and, LogicalOpType.in, null, ModelWikiStructureInfoKeyItem.FI_ITEMID, ModelWikiStructureInfoKeyItem.FI_ITEMID, ColumnDataType.intData);
        }
        sqlBuilder.setLimit();
        return getResults(assembler, sqlBuilder, param);
    }
    ...
    public ModelWikiStructureInfoKeyItem insert(ModelWikiStructureInfoKeyItem instance, DaoAssembler assembler) {
        SQLInsert sqlBuilder = SQL.buildInsertSql(ModelWikiStructureInfoKeyItem.DTO_TABLE_NAME);
        Integer dItemId = instance.getItemId();
        if (dItemId!= null) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMID);
        }
    ...
    public Integer insert(List<ModelWikiStructureInfoKeyItem> instances, Set<String> fields, DaoAssembler assembler) {
        ...
        if (fields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE);
        }
        if (fields.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
            sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE);
        }
    ...
    public Integer update(ModelWikiStructureInfoKeyItem instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLUpdate sqlBuilder = SQL.buildUpdateSql(ModelWikiStructureInfoKeyItem.DTO_TABLE_NAME);
        Integer dItemId = instance.getItemId();
        ...
        Short dItemHasValue = instance.getItemHasValue();
        if (conditionField.contains(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
            assert((dItemHasValue!= null));
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, ColumnDataType.shortData);
        } else {
            if (dItemHasValue!= null) {
                sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE);
        ...
        String dItemDefaultValue = instance.getItemDefaultValue();
        if (conditionField.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
            assert((dItemDefaultValue!= null));
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, ColumnDataType.stringData);
        } else {
            if (dItemDefaultValue!= null) {
                sqlBuilder.items(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE);
    ...
    public Integer updateByIds(ModelWikiStructureInfoKeyItem instance, Set<Integer> ids, DaoAssembler assembler) {
        ...
        sqlBuilder.where(LogicalOpType.in, ModelWikiStructureInfoKeyItem.FI_ITEMID, "ids", ColumnDataType.intData);
    ...
    public Integer delete(ModelWikiStructureInfoKeyItem instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLDelete sqlBuilder = SQL.buildDeleteSql(ModelWikiStructureInfoKeyItem.DTO_TABLE_NAME);
        Integer dItemId = instance.getItemId();
        if (conditionField.contains(ModelWikiStructureInfoKeyItem.FI_ITEMID)) {
            assert((dItemId!= null));
            sqlBuilder.where(ModelWikiStructureInfoKeyItem.FI_ITEMID, ColumnDataType.intData);
    ...
    public ModelWikiStructureInfoKeyItem updateOrInsert(ModelWikiStructureInfoKeyItem instance, Set<String> conditionField, AbstractMultipleDaoAssembler assembler) {
        ...
        if (conditionField.contains(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
            checkInstance.setItemHasValue(instance.getItemHasValue());
        }
        if (conditionField.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
            checkInstance.setItemDefaultValue(instance.getItemDefaultValue());
        }
