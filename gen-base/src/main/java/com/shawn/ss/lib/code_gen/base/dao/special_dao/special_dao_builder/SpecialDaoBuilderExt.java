...
public class SpecialDaoBuilderExt extends AbstractDaoBuilder {
    ...
    public SpecialDaoBuilderExt(SpecialModelConf def, ModelBuilderContext builderContext) {
            ...
            if (definedClass == null) {
                ...
                if (loggerField == null) {
                    ...
                    if (fields.containsKey(CodeHelper.FIELD_DAO_LOGGER)) {
                        ...
                        loggerField = definedClass.field(
                                CodeHelper.MODE_PUBLIC_STATIC_FINAL, cm.ref(Logger.class), CodeHelper.FIELD_DAO_LOGGER,
