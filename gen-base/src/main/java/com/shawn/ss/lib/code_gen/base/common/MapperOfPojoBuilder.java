...
//    }
    ...
    public MapperOfPojoBuilder(CommonPOJOConf modelDef, ModelBuilderContext context,JDefinedClass enclosingClz){
...
//            poModelDef = null;
    ...
    private void buildInterception(CommonModelDef poModelDef, CommonPOJOConf modelDef) {
        if(poModelDef!=null){
