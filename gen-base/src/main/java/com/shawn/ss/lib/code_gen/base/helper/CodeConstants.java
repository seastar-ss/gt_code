...
public class CodeConstants {
    ...
    public static final String FIELD_RESULT_SET_MAPPER_INSTANCE = "RESULT_SET_OBJ_MAPPER";
    ...
    public static final String FIELD_REDIS_MAP_MAPPER_INSTANCE = "MAP_OBJ_MAPPER";
