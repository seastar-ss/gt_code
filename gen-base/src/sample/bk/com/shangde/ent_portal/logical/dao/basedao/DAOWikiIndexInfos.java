    ...
    implements DaoInterface<com.shangde.ent_portal.logical.dto.basepo.ModelWikiIndexInfos, Integer> , InitializingBean
{
    ...
    protected List<ModelWikiIndexInfos> getResults(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
    ...
    protected ModelWikiIndexInfos getResult(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
            status = assembler.assembleSql(sqlBuilder, param, ModelWikiIndexInfos.class);
        }
    ...
    protected void buildConditionCluase(SQLSelect<SQLSelect> sqlBuilder, ModelWikiIndexInfos instance, Map<String, Object> param) {
        Integer dCmsIndexInfoId = instance.getCmsIndexInfoId();
        if (dCmsIndexInfoId!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINDEXINFOID, ColumnDataType.intData);
        ...
        if (dCmsIndexInfoState!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINDEXINFOSTATE, ColumnDataType.byteData);
        ...
        if (dCmsInfoCreateTime!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFOCREATETIME, ColumnDataType.timeStampData);
            param.put(ModelWikiIndexInfos.FI_CMSINFOCREATETIME, dCmsInfoCreateTime);
        }
        String dCmsInfoKey = instance.getCmsInfoKey();
        if (dCmsInfoKey!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFOKEY, ColumnDataType.stringData);
        ...
        if (dCmsInfoValue!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFOVALUE, ColumnDataType.stringData);
        ...
        if (dCmsInfoName!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFONAME, ColumnDataType.stringData);
        ...
        if (dCmdInfoAspect!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMDINFOASPECT, ColumnDataType.stringData);
        ...
        if (dCmsInfoDesc!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFODESC, ColumnDataType.stringData);
        ...
        if (dCmsInfoOfIndexId!= null) {
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINFOOFINDEXID, ColumnDataType.intData);
    ...
    public List<ModelWikiIndexInfos> get(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count) {
        ...
        SQLSelect<SQLSelect> sqlBuilder = SQL.buildSelectSql(ModelWikiIndexInfos.DTO_TABLE_NAME);
        if (start == null) {
    ...
    public List<ModelWikiIndexInfos> getById(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count, List<Integer> cmsIndexInfoId) {
        ...
        if (cmsIndexInfoId!= null) {
            sqlBuilder.where(LogicalRelationshipType.and, LogicalOpType.in, null, ModelWikiIndexInfos.FI_CMSINDEXINFOID, ModelWikiIndexInfos.FI_CMSINDEXINFOID, ColumnDataType.intData);
        }
        sqlBuilder.setLimit();
        return getResults(assembler, sqlBuilder, param);
    }
    ...
    public ModelWikiIndexInfos insert(ModelWikiIndexInfos instance, DaoAssembler assembler) {
        SQLInsert sqlBuilder = SQL.buildInsertSql(ModelWikiIndexInfos.DTO_TABLE_NAME);
        Integer dCmsIndexInfoId = instance.getCmsIndexInfoId();
        if (dCmsIndexInfoId!= null) {
            sqlBuilder.items(ModelWikiIndexInfos.FI_CMSINDEXINFOID);
        }
    ...
    public Integer update(ModelWikiIndexInfos instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLUpdate sqlBuilder = SQL.buildUpdateSql(ModelWikiIndexInfos.DTO_TABLE_NAME);
        Integer dCmsIndexInfoId = instance.getCmsIndexInfoId();
    ...
    public Integer updateByIds(ModelWikiIndexInfos instance, Set<Integer> ids, DaoAssembler assembler) {
        ...
        sqlBuilder.where(LogicalOpType.in, ModelWikiIndexInfos.FI_CMSINDEXINFOID, "ids", ColumnDataType.intData);
    ...
    public Integer delete(ModelWikiIndexInfos instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLDelete sqlBuilder = SQL.buildDeleteSql(ModelWikiIndexInfos.DTO_TABLE_NAME);
        Integer dCmsIndexInfoId = instance.getCmsIndexInfoId();
        if (conditionField.contains(ModelWikiIndexInfos.FI_CMSINDEXINFOID)) {
            assert((dCmsIndexInfoId!= null));
            sqlBuilder.where(ModelWikiIndexInfos.FI_CMSINDEXINFOID, ColumnDataType.intData);
