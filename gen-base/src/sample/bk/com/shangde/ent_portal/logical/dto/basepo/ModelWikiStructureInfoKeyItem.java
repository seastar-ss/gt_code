    ...
    extends AbstractBaseModel
{
    ...
    /**
     * 对应数据库.wiki_structure_info_key_item.itemHasValue 字段
     * 保留字段
     */
    Short itemHasValue;
    public final static String FI_ITEMHASVALUE = "itemHasValue";
    /**
     * 对应数据库.wiki_structure_info_key_item.itemDefaultValue 字段
     * 字段默认值
     */
    String itemDefaultValue;
    public final static String FI_ITEMDEFAULTVALUE = "itemDefaultValue";
    public final static Map<String, Object> FIELD_CLASS = CollectionHelper.<String, Object> mapBuilder().put(ModelWikiStructureInfoKeyItem.FI_ITEMID, Integer.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMNAME, String.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMTYPE, EnumItemType.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMVALUETYPE, EnumItemValueType.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMLABEL, String.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMREADONLY, Byte.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMOBTAINMETHOD, String.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG, Byte.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION, Integer.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMDESP, String.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE, Byte.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, Short.class).put(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, String.class).getMap();
    ...
    public Byte getItemDeleteFlag() {
        return itemDeleteFlag;
    }

    public ModelWikiStructureInfoKeyItem setItemDeleteFlag(Byte lItemDeleteFlag) {
    ...
    public Short getItemHasValue() {
        return itemHasValue;
    }

    public ModelWikiStructureInfoKeyItem setItemHasValue(Short lItemHasValue) {
        itemHasValue = lItemHasValue;
        return this;
    }
    ...
    public ModelWikiStructureInfoKeyItem setItemDefaultValue(String lItemDefaultValue) {
        itemDefaultValue = lItemDefaultValue;
        return this;
    }
    ...
    public boolean isEmpty() {
        ...
        if (getItemHasValue()!= null) {
            return false;
        }
        if (getItemDefaultValue()!= null) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        ...
        ret.append("{").append("itemHasValue").append(":").append(itemHasValue).append("}\n");
        ret.append("{").append("itemDefaultValue").append(":").append(itemDefaultValue).append("}\n");
        return ret.toString();
    }
        ...
        implements RedisMapMapper<ModelWikiStructureInfoKeyItem>
    {
                                                ...
                                                if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION)) {
                                                    ...
                                                    if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDESP)) {
                                                        ...
                                                        if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE)) {
                                                            ...
                                                            if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
                                                                instance.setItemHasValue(mapToFieldItemHasValue(entry.getValue()));
                                                            } else {
                                                                if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
                                                                    instance.setItemDefaultValue(mapToFieldItemDefaultValue(entry.getValue()));
                                                                }
                                                            }
                                                        }
                                                    }
        ...
        protected Byte mapToFieldItemDeleteFlag(byte[] bytes) {
            return TypeConstantHelper.toObject(bytes, Byte.class);
        }
        ...
        protected Short mapToFieldItemHasValue(byte[] bytes) {
            return TypeConstantHelper.toObject(bytes, Short.class);
        }

        protected String mapToFieldItemDefaultValue(byte[] bytes) {
            return TypeConstantHelper.toObject(bytes, String.class);
        }
        ...
        public Map<byte[], byte[]> toMap(ModelWikiStructureInfoKeyItem instance) {
            ...
            byte[] valueItemHasValue = mapFromFieldItemHasValue(instance.getItemHasValue());
            ret.put(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE.getBytes(), valueItemHasValue);
            byte[] valueItemDefaultValue = mapFromFieldItemDefaultValue(instance.getItemDefaultValue());
            ret.put(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE.getBytes(), valueItemDefaultValue);
            return ret;
        }
        ...
        protected byte[] mapFromFieldItemDeleteFlag(Byte field) {
            byte[] ret = TypeConstantHelper.fromObjectBin(field);
            return ret;
        }
        ...
        protected byte[] mapFromFieldItemHasValue(Short field) {
            byte[] ret = TypeConstantHelper.fromObjectBin(field);
            return ret;
        }

        protected byte[] mapFromFieldItemDefaultValue(String field) {
            byte[] ret = TypeConstantHelper.fromObjectBin(field);
            return ret;
        }
        ...
        public Map<String, Object> toCommonMap(ModelWikiStructureInfoKeyItem instance) {
            ...
            if (dItemHasValue!= null) {
                ret.put(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, dItemHasValue);
            }
            String dItemDefaultValue = instance.getItemDefaultValue();
            if (dItemDefaultValue!= null) {
                ret.put(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, dItemDefaultValue);
            }
            return ret;
        }
        ...
        public ModelWikiStructureInfoKeyItem fromCommonMap(Map<String, Object> param) {
            ...
            Object dItemHasValue = param.get(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE);
            if (dItemHasValue!= null) {
                this.setField(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE, ret, dItemHasValue);
            }
            Object dItemDefaultValue = param.get(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE);
            if (dItemDefaultValue!= null) {
                this.setField(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE, ret, dItemDefaultValue);
            }
            return ret;
        }
        ...
        protected Byte mapToFieldItemDeleteFlag(Object obj) {
            return ((Byte) obj);
        }
        ...
        protected Short mapToFieldItemHasValue(Object obj) {
            return ((Short) obj);
        }

        protected String mapToFieldItemDefaultValue(Object obj) {
            return ((String) obj);
        }
                                                ...
                                                if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION)) {
                                                    ...
                                                    if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDESP)) {
                                                        ...
                                                        if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE)) {
                                                            ...
                                                            if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
                                                                return ((TT) instance.getItemHasValue());
                                                            } else {
                                                                if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
                                                                    return ((TT) instance.getItemDefaultValue());
                                                                }
                                                            }
                                                        }
                                                    }
                                            ...
                                            if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMBELONGCOLLECTION)) {
                                                ...
                                                if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDESP)) {
                                                    ...
                                                    if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMSEQUENCE)) {
                                                        ...
                                                        if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
                                                            try {
                                                                instance.setItemHasValue(mapToFieldItemHasValue(value));
                                                            } catch (final Exception ex) {
                                                                ex.printStackTrace();
                                                            }
                                                        } else {
                                                            if (field.equals(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
                                                                try {
                                                                    instance.setItemDefaultValue(mapToFieldItemDefaultValue(value));
                                                                } catch (final Exception ex) {
                                                                    ex.printStackTrace();
                                                                }
                                                            }
        ...
        implements DbResultSetMapper<T>
    {
            ...
            throws SQLException
        {
            ...
            mapFieldItemHasValue(rs, columnNames, instance);
            mapFieldItemDefaultValue(rs, columnNames, instance);
            ...
            throws SQLException
        {
            if (columnNames.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG)) {
                instance.setItemDeleteFlag(rs.getByte(ModelWikiStructureInfoKeyItem.FI_ITEMDELETEFLAG));
            }
        }
        ...
        protected void mapFieldItemHasValue(ResultSet rs, Set<String> columnNames, T instance)
            throws SQLException
        {
            if (columnNames.contains(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE)) {
                instance.setItemHasValue(rs.getShort(ModelWikiStructureInfoKeyItem.FI_ITEMHASVALUE));
            }
        }

        protected void mapFieldItemDefaultValue(ResultSet rs, Set<String> columnNames, T instance)
            throws SQLException
        {
            if (columnNames.contains(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE)) {
                instance.setItemDefaultValue(rs.getString(ModelWikiStructureInfoKeyItem.FI_ITEMDEFAULTVALUE));
            }
        }
    }
}
