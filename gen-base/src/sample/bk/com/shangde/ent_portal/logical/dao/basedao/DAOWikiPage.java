    ...
    implements DaoInterface<com.shangde.ent_portal.logical.dto.basepo.ModelWikiPage, Integer> , InitializingBean
{
    ...
    protected List<ModelWikiPage> getResults(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
    ...
    protected ModelWikiPage getResult(DaoAssembler assembler, SQL<SQLSelect> sqlBuilder, Map<String, Object> param) {
        int status = 0;
        if (assembler!= null) {
            status = assembler.assembleSql(sqlBuilder, param, ModelWikiPage.class);
        }
    ...
    protected void buildConditionCluase(SQLSelect<SQLSelect> sqlBuilder, ModelWikiPage instance, Map<String, Object> param) {
        ...
        if (dPageSubmitByGp!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGESUBMITBYGP, ColumnDataType.intData);
        ...
        if (dPageSubmitByIns!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGESUBMITBYINS, ColumnDataType.intData);
        ...
        if (dPageSubmitByFamily!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGESUBMITBYFAMILY, ColumnDataType.intData);
        ...
        if (dPageCreatedOn!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGECREATEDON, ColumnDataType.timeStampData);
        ...
        if (dPageAddition!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGEADDITION, ColumnDataType.stringData);
            param.put(ModelWikiPage.FI_PAGEADDITION, dPageAddition);
        }
        Byte dPageState = instance.getPageState();
        if (dPageState!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGESTATE, ColumnDataType.byteData);
        ...
        if (dPageDisplayMethod!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGEDISPLAYMETHOD, ColumnDataType.stringData);
            param.put(ModelWikiPage.FI_PAGEDISPLAYMETHOD, dPageDisplayMethod);
        }
        Byte dPageAspect = instance.getPageAspect();
        if (dPageAspect!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGEASPECT, ColumnDataType.byteData);
            param.put(ModelWikiPage.FI_PAGEASPECT, dPageAspect);
        }
        EnumPageType dPageType = instance.getPageType();
        if (dPageType!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGETYPE, ColumnDataType.byteData);
        ...
        if (dPageResourceUrl!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGERESOURCEURL, ColumnDataType.stringData);
        ...
        if (dPageFileSize!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGEFILESIZE, ColumnDataType.longData);
        ...
        if (dPageRelatedObject!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGERELATEDOBJECT, ColumnDataType.intData);
        ...
        if (dPageSubmitByTopIns!= null) {
            sqlBuilder.where(ModelWikiPage.FI_PAGESUBMITBYTOPINS, ColumnDataType.intData);
    ...
    public List<ModelWikiPage> get(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count) {
        ...
        SQLSelect<SQLSelect> sqlBuilder = SQL.buildSelectSql(ModelWikiPage.DTO_TABLE_NAME);
        if (start == null) {
    ...
    public List<ModelWikiPage> getById(Set<String> selectFields, DaoAssembler assembler, Integer start, Integer count, List<Integer> pageId) {
        ...
        buildSelectFieldCluase(sqlBuilder, selectFields);
        if (pageId!= null) {
            sqlBuilder.where(LogicalRelationshipType.and, LogicalOpType.in, null, ModelWikiPage.FI_PAGEID, ModelWikiPage.FI_PAGEID, ColumnDataType.intData);
        }
        sqlBuilder.setLimit();
        return getResults(assembler, sqlBuilder, param);
    }
    ...
    public ModelWikiPage insert(ModelWikiPage instance, DaoAssembler assembler) {
        SQLInsert sqlBuilder = SQL.buildInsertSql(ModelWikiPage.DTO_TABLE_NAME);
        Integer dPageId = instance.getPageId();
        if (dPageId!= null) {
            sqlBuilder.items(ModelWikiPage.FI_PAGEID);
        }
    ...
    public Integer update(ModelWikiPage instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLUpdate sqlBuilder = SQL.buildUpdateSql(ModelWikiPage.DTO_TABLE_NAME);
        Integer dPageId = instance.getPageId();
    ...
    public Integer updateByIds(ModelWikiPage instance, Set<Integer> ids, DaoAssembler assembler) {
        ...
        sqlBuilder.where(LogicalOpType.in, ModelWikiPage.FI_PAGEID, "ids", ColumnDataType.intData);
    ...
    public Integer delete(ModelWikiPage instance, Set<String> conditionField, DaoAssembler assembler) {
        SQLDelete sqlBuilder = SQL.buildDeleteSql(ModelWikiPage.DTO_TABLE_NAME);
        Integer dPageId = instance.getPageId();
        if (conditionField.contains(ModelWikiPage.FI_PAGEID)) {
            assert((dPageId!= null));
            sqlBuilder.where(ModelWikiPage.FI_PAGEID, ColumnDataType.intData);
