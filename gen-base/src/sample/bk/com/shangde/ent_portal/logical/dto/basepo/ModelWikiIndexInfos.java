    ...
    extends AbstractBaseModel
{
    ...
    public final static Map<String, Object> FIELD_CLASS = CollectionHelper.<String, Object> mapBuilder().put(ModelWikiIndexInfos.FI_CMSINDEXINFOID, Integer.class).put(ModelWikiIndexInfos.FI_CMSINDEXINFOSTATE, Byte.class).put(ModelWikiIndexInfos.FI_CMSINFOCREATETIME, Date.class).put(ModelWikiIndexInfos.FI_CMSINFOKEY, String.class).put(ModelWikiIndexInfos.FI_CMSINFOVALUE, String.class).put(ModelWikiIndexInfos.FI_CMSINFONAME, String.class).put(ModelWikiIndexInfos.FI_CMDINFOASPECT, String.class).put(ModelWikiIndexInfos.FI_CMSINFODESC, String.class).put(ModelWikiIndexInfos.FI_CMSINFOOFINDEXID, Integer.class).getMap();
    public final static Integer FIELD_COUNT = 9;
