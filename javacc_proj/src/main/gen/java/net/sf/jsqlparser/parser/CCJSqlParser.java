...
return result;
  ...
  private boolean jj_3R_503()
 {
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[426];
  ...
  public CCJSqlParser(Provider stream) {
	 ...
	 jj_ntk = -1;
	 jj_gen = 0;
	 for (int i = 0; i < 426; i++) jj_la1[i] = -1;
