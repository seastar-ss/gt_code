...
public abstract class AbstractJType implements IJGenerable, IJOwned {
     ...
     *
     * @param aCodeModel Base code model
     * @param sTypeName  primitive type to be parsed (e.g. "int" or "void")
     * @return Never <code>null</code>
     * @throws IllegalArgumentException If the passed type name is not a primitive type name
     */
    @Nonnull
     ...
     *
     * @return Never <code>null</code>.
     * @throws IllegalArgumentException If this is not an array type
     */
    @Nonnull
     ...
     * variable.
     *
     * @param aVar The type variable to check. May be <code>null</code>.
    ...
    protected boolean isAssignableFrom(@Nonnull final AbstractJType aThat, final boolean bAllowsRawTypeUnchekedConversion) {
        ...
        if (this.equals(aThat))
            return true;
        if (Objects.equals(this.fullName(), aThat.fullName())) {
            return true;
        }
